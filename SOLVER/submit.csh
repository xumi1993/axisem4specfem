...
# cd ../build
# cmake ..
# if ! { make -j axisem xpost_processing xfield_transform }  then
#   echo "ERROR: Compilation failed, please check the errors."
#   exit
# endif
# cd $homedir

if ( ! -f axisem && -f ../bin/axisem ) then
    ln -s ../bin/axisem .
endif
if ( ! -f xpost_processing && -f ../bin/xpost_processing ) then
    ln -s ../bin/xpost_processing .
endif
if ( ! -f xfield_transform && -f ../bin/xfield_transform ) then
    ln -s ../bin/xfield_transform .
endif
